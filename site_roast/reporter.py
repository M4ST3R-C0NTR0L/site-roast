...
"""
    ...
    def generate(self, audit: WebsiteAudit) -> str:
        ...
        lines.append(f"{self.DIM}https://cybrflux.online{self.RESET}\n")
...
class MarkdownReporter(BaseReporter):
    ...
    def generate(self, audit: WebsiteAudit) -> str:
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Generated by [site-roast](https://github.com/cybrflux/site-roast) — Built by [Cybrflux](https://cybrflux.online)*")
